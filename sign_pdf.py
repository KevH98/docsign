...
def create_self_signed_cert(pKey):
    ...
    cert.get_subject().CN = "Kevin Harris"
    # Serial Number
...
def load():
    ...
    # PEM encoded
    with open(Path('./static/private_key.pem'), 'wb') as pk:
    ...
    with open(Path('./static/certificate.cer'), 'wb') as cer:
    ...
    with open(Path('./static/public_key.pem'), 'wb') as pub_key:
    ...
    open(Path('./static/container.pfx'), 'wb').write(p12.export())
...
def sign_file(input_file: str, signatureID: str, x_coordinate: int,
    ...
    PDFNet.Initialize("demo:1662933576443:7a1229f503000000006fb209439ba71920fb525dc73d6b016123bf064f")
